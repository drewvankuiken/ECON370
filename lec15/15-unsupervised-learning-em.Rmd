...
source("./secret_outside_script1.R")
```

```{r gmm2, include=FALSE}
source("./secret_outside_script2.R")
```
...
```{r mclustPackage,message=F, eval=FALSE}
library(mclust)
...
```{r joint_est_mclust,message=F,warning=F,cache=T, eval=FALSE}
